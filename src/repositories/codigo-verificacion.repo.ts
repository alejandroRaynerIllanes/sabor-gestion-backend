...
export class CodigoVerificacionRepository {
  async crear(usuarioId: string, codigo: string, tipo: string, expiracion: Date): Promise<ICodigoVerificacion> {
  ...
  async buscarPorCodigoYUsuario(codigo: string, usuarioId: string, tipo: string): Promise<ICodigoVerificacion | null> {
